...
from src.eval.llava.m4c_evaluator import EvalAIAnswerProcessor
...
if __name__ == '__main__':
    ...
    src = os.path.join('./playground/data/eval/vqav2', 'answers', args.split, args.ckpt, 'merge.jsonl')
    test_split = os.path.join(args.dir, 'llava_vqav2_mscoco_test2015.jsonl')
    dst = os.path.join('./playground/data/eval/vqav2', 'answers_upload', args.split, f'{args.ckpt}.json')
