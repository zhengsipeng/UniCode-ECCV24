...
# scenes = loadFile(args.dir, args.scenes.format(tier = args.tier))

# Load questions
print("Loading questions...")
questions = loadFile(args.dir, args.questions.format(tier = args.tier))

# # Load choices
# print("Loading choices...")
# choices = loadFile(args.dir, args.choices.format(tier = args.tier))

# Load predictions and turn them into a dictionary
print("Loading predictions...")
predictions = loadFile(args.dir, args.predictions.format(tier = args.tier))
