...
def create_dataset(name):
    ...
    if name == 'imagenet':
        ...
        root = '/share/project/datasets/minedojo_april/vlm-pretrain/llava/pretrain/BLIP-LAION-CC-SBU-558k/images'
        dataset = LLavaDataset(root, split='val', transform=transforms_)
    else:
        raise ValueError()
