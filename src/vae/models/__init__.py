...
from src.vae.utils.sampling import sampling_igpt
from src.vae.utils.config2 import get_base_config
from src.vae.optimizers.scheduler import build_scheduler

from .stage1.vqgan import VQGAN
from .stage1.generator import VQGANGenerator, VQGAN2Generator, SimRQGAN2Generator, RQGenerator
...
def build_model(model_name, cfg_stage1, cfg_opt):
    if model_name == 'vqgan':
        ...
        generator = SimRQGAN2Generator(n_embed=cfg_stage1.n_embed,
                                       ...
                                       hparams=cfg_stage1.hparams,
                                       hparams_aux=cfg_stage1.hparams_aux)
    elif model_name == 'rqvae':
        generator = RQGenerator(n_embed=cfg_stage1.n_embed,
                                embed_dim=cfg_stage1.embed_dim,
                                ema_update=cfg_stage1.ema_update,
                                hparams=cfg_stage1.hparams,
                                hparams_aux=cfg_stage1.hparams_aux)
